                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <form action="<?= url("admin/banner/update/" . $edited_banner['id']) ?>" enctype="multipart/form-data" method="POST">
                                                ...
                                                <table class="table align-items-center ">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="col text-center">
                                                                    <input type="text" class="form-control alert-light col-7 p-2" value="<?= $edited_banner['url'] ?>" name="banner-url" placeholder="banner url" autofocus>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="text-center">
                                                                    <input type="file" class="form-control alert-light col-7 p-2" name="banner-img">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="text-center">
                                                                    <h6 class="text-sm font-weight-normal mb-0 "><?= date("y", strtotime($edited_banner['created_at'])) . date("M", strtotime($edited_banner['created_at'])) . date("d", strtotime($edited_banner['created_at'])) ?></h6>
                                                                </div>
                                                            </td>
                                                            <td class="align-middle text-sm">
                                                                <div class="col text-center">
                                                                    <button type="submit" class="btn btn-success"><i class="fa fa-check"></i></button>
                                                                    <a href="<?= url("admin/banner") ?>" class="btn btn-danger" onclick="return confirm('Are you sure? all saves will be eleminated');"><i class="fa fa-times" aria-hidden="true"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php
