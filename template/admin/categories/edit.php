                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <form action="<?= url("admin/category/update/" . $edit_cat['id']) ?>" method="POST">
                                                ...
                                                <table class="table align-items-center ">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="col text-center">
                                                                    <h6 class="text-sm font-weight-normal mb-0 ">
                                                                        <input type="text" class="form-control input-group-text alert-light" name="cat-name" value="<?= $edit_cat['name'] ?>" autofocus>
                                                                    </h6>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="align-middle text-sm">
                                                                <div class="col text-center">
                                                                    <h6 class="text-xs font-weight-bold mb-0 "><?= $edit_cat['created_at'] ?></h6>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="align-middle text-sm">
                                                                <div class="col text-center">
                                                                    ...
                                                                    <a href="<?= url("admin/category") ?>" class="btn btn-danger" onclick="return confirm('Are you sure? all changes will be elmenated');"><i class="fa fa-times" aria-hidden="true"></i></a>
                                                                </div>
                                                            </td>
